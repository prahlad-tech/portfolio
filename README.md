...
- **Frontend:** React.js, JavaScript (AJAX), HTML5, CSS3, Bootstrap, Tailwind CSS
- **Database:** MySQL
- **AI & Automation:** AI Agent Development (Pabbly & Webhooks), Workflow Automation
- **Payments:** Razorpay, PayPal, Stripe, Braintree, Cardcom, Elavon
- **Other:** REST API, JWT / Sanctum Auth, Git & GitHub, MVC Architecture
